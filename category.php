...
<head>
    ...
    <title>Category - <?php echo $query ?></title>
    <meta name="description" content="Get Latest News & Updates on <?php echo $query ?> Category">
            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  <?php
                        ...
                        $getpost = "SELECT * FROM post WHERE category = '$query' ORDER BY post_id DESC LIMIT $offset, $recordsperpage";
                    ...
                    <?php }}
                        $allpost = "SELECT * FROM post WHERE category = '$query'";

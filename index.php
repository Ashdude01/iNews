...
<head>
    ...
    <meta name="description" content="Get Latest News on Trending Topics, Entertainment, finance, lifestyle, technology, politics latest news & updates">
    <meta name="keywords" content="latest news, top news, trending today news abc news alt news">
    <!-- Bootstrap -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="inner-content clearfix">
                                        ...
                                        <p class="description">
                                        <?php echo substr($post['description'],0,140)."..."?>                                        </p>

...
<head>
    ...
    <title>Author - <?php echo $query ?></title>
    <meta name="description" content="Get Latest News & Updates Published by <?php echo $query ?>">
            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  <?php
                        ...
                        $getpost = "SELECT * FROM post WHERE author = '$query' ORDER BY post_id DESC LIMIT $offset, $recordsperpage";
                    ...
                    <?php }}
                        $allpost = "SELECT * FROM post WHERE author = '$query'";
